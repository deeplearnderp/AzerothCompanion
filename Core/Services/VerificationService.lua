...
local CHECKLIST =
{
    ...
    { id = "Death", labelKey = "Developer.ChecklistDeath", relatedIds = { "char.bestMap" } },
    ...
    { id = "KeystoneComplete", labelKey = "Developer.ChecklistKeystoneComplete", relatedIds = { "mp.eventsWiki", "mp.eventOrdering", "weekly.progressUnits", "pj.eventOrderingDefer" } },
    ...
    -- Player Journal & Community Observations -------------------------------------------
    { id = "PlayerJournalRun", labelKey = "Developer.ChecklistPlayerJournalRun", relatedIds = { "pj.rosterUnitAccessors", "pj.eventOrderingDefer" } },
