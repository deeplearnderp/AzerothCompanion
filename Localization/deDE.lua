...
-- Localization: deDE
--
-- No translations yet -- LocalizationService falls back to enUS for every
-- key until this table is filled in.
-------------------------------------------------------------------------------
...
AC.Locales.deDE = {
    ...
    ["InventoryManager.LoadoutsLibraryHint"] = "Build reusable plans for raids, dungeons, and preparation.",
    ...
    ["InventoryManager.LoadoutEditorEmptySubtitle"] = "Create your first loadout to begin organizing inventory plans.",
    ["InventoryManager.LoadoutsEmptyTitle"] = "Create your first loadout",
    ["InventoryManager.LoadoutsEmptyDescription"] = "Loadouts help you prepare a full inventory plan for a specific activity without rethinking it each time.",
    ["InventoryManager.LoadoutsEmptyExamplesTitle"] = "Useful for:",
    ["InventoryManager.LoadoutsExampleRaid"] = "Raiding and dungeon preparation",
    ["InventoryManager.LoadoutsExampleProfession"] = "Profession and crafting sessions",
    ["InventoryManager.LoadoutsExampleTravel"] = "Travel, event, or seasonal activities",
    ...
    ["InventoryManager.LoadoutAddItemButton"] = "Add",
