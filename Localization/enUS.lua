...
AC.Locales.enUS =
{
    ...
    ["Dashboard.TooltipHistory"] = "View your complete recorded activity history",
    ["Dashboard.NoHistory"] = "No recent activity",
    ...
    ["ActivityLog.DelveJournalTitleWithTier"] = "%s %d - %s",
    ["ActivityLog.DelveJournalTitle"] = "%s - %s",
    ["ActivityLog.DelvePartyMembers"] = "Party Members",
    ["ActivityLog.DelveCompletionTime"] = "Completion Time",
    ...
    ["Developer.ModulesLifecycleLimitation"] = "Registered services and modules are listed with only the capabilities they expose. Lifecycle state is not inferred.",
    ["Developer.ModulesCapabilities"] = "Capabilities",
    ["Developer.ModulesDiagnostics"] = "Diagnostics",
    ["Developer.ModulesReadOnly"] = "Read-only",
    ["Developer.TabCombatSession"] = "Combat Session",
    ["Developer.TabEvents"] = "Events",
    ["Developer.TabErrors"] = "Errors",
    ["Developer.TabSecretValues"] = "Secret Values",
    ["Developer.TabLiveAPI"] = "Live API",
    ["Developer.TabAPIExplorer"] = "API Explorer",
    ["Developer.TabHistory"] = "History",
    ["Developer.TabChecklist"] = "Checklist",
    ["Developer.TabMaintenance"] = "Maintenance",
    ["Developer.NavConsole"] = "Console",
    ["Developer.NavRuntime"] = "Runtime",
    ["Developer.NavAPIs"] = "Blizzard APIs",
    ["Developer.NavData"] = "Data & Maintenance",
    ["Developer.CombatSessionStatus"] = "Service Status",
    ["Developer.CombatSessionInitialized"] = "Initialized",
    ["Developer.CombatSessionEnabled"] = "Enabled",
    ["Developer.CombatSessionAPIAvailable"] = "API Available",
    ["Developer.CombatSessionLastReason"] = "Last Refresh Reason",
    ["Developer.CombatSessionCache"] = "Cache Statistics",
    ["Developer.CombatSessionCached"] = "Cached Sessions",
    ["Developer.CombatSessionCacheLimit"] = "Cache Limit",
    ["Developer.CombatSessionUpdates"] = "Updates",
    ["Developer.CombatSessionResets"] = "Resets",
    ["Developer.CombatSessionObserved"] = "Observed Sessions",
    ["Developer.CombatSessionEvicted"] = "Evicted Sessions",
    ["Developer.CombatSessionLatest"] = "Latest Session",
    ["Developer.CombatSessionSessionID"] = "Session ID",
    ["Developer.CombatSessionParticipants"] = "Participant Count",
    ["Developer.CombatSessionDeaths"] = "Death Count",
    ["Developer.CombatSessionLastUpdated"] = "Last Updated",
    ["Developer.CombatSessionUpdatedAgo"] = "%.1fs ago",
    ["Developer.CombatSessionParticipantSection"] = "Participants",
    ["Developer.CombatSessionDeathSection"] = "Deaths",
    ["Developer.CombatSessionLocalPlayer"] = "Local Player",
    ["Developer.CombatSessionRecapID"] = "Recap ID",
    ["Developer.CombatSessionRecapAvailable"] = "Recap Available",
    ["Developer.CombatSessionRecapEvents"] = "Recap Event Count",
    ["Developer.CombatSessionNoSession"] = "No combat session available.",
    ["Developer.CombatSessionNoParticipants"] = "No normalized participants available.",
    ["Developer.CombatSessionNoDeaths"] = "No normalized deaths available.",

    ["Developer.APIExplorerFunction"] = "Function",
    ["Developer.APIExplorerArguments"] = "Arguments",
    ["Developer.APIExplorerExecute"] = "Execute",
    ["Developer.APIExplorerResults"] = "Results",
    ["Developer.APIExplorerReady"] = "Enter a Blizzard API function and execute it.",
    ["Developer.APIExplorerNoResults"] = "No API results yet.",
    ["Developer.APIExplorerSearch"] = "Search",
    ["Developer.APIExplorerFavorite"] = "Favorite",
    ["Developer.APIExplorerCopyResult"] = "Copy Result",
    ["Developer.APIExplorerFavorites"] = "Favorites",
    ["Developer.APIExplorerRecent"] = "Recent",
    ["Developer.APIExplorerBlizzardAPIs"] = "Blizzard APIs",
    ...
    ["Developer.LabelRegistered"] = "Registered",
